...
from node_classify.models.MFNN import *
...
def parse_args():
    ...
    parser.add_argument('--tran_dropout', type=float, default=0.5)
    ...
    parser.add_argument('--net', type=str,
                        choices=['GCN', 'GAT', 'APPNP', 'ChebNet', 'JKNet', 'GPRGNN', 'BernNet', 'HiGCN','MFNN','MFNN2'],
                        default ='MFNN'
                        )
