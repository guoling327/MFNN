...
def my_args(args):
    args += ['--model', 'MFNN_gin']  # sparse_cin, MFNN_gin
    args += ['--petalType', "simplex"]  # simplex,ring
    args += ['--max_petal_dim', "2"]
    args += ['--exp_name', 'MFNN']  # 1:mpsn-redditb,2:MFNN-NCI1,3:gin-NCI1 4:MFNN-MUTAG 5:MFNN-PTC, 6:MFNN-NCI109
    args += ['--dataset',
             'NCI109']  # 1:REDDITBINARY, 2:NCI1, 3:NCI1 4:MUTAG, 5:PTC, 6:NCI109， 7:IMDBBINARY 8：IMDBMULTI,9:PROTEINS, REDDITMULTI5K
    args += ['--epochs', '300']  # 200
...
def mpsn_args(args):
    args += ['--model', 'sparse_cin']  # sparse_cin, MFNN_gin
    args += ['--petalType', "simplex"]  # simplex,ring
    args += ['--max_petal_dim', "2"]
    args += ['--exp_name',
             'MPSN-MUTAG']  # 1:mpsn-redditb,2:MFNN-NCI1,3:gin-NCI1 4:MFNN-MUTAG 5:MFNN-PTC, 6:MFNN-NCI109
    args += ['--dataset',
             'MUTAG']  # 1:REDDITBINARY, 2:NCI1, 3:NCI1 4:MUTAG, 5:PTC, 6:NCI109， 7:IMDBBINARY 8：IMDBMULTI,9:PROTEINS, REDDITMULTI5K
    args += ['--epochs', '200']  # 200
...
def COLLAB_args(args):
    ...
    args += ['--max_petal_dim', "2"]
    args += ['--exp_name',
             'MFNN_gin']  # 1:mpsn-redditb,2:MFNN-NCI1,3:gin-NCI1 4:MFNN-MUTAG 5:MFNN-PTC, 6:MFNN-NCI109
    args += ['--dataset',
             'COLLAB']  # 1:REDDITBINARY, 2:NCI1, 3:NCI1 4:MUTAG, 5:PTC, 6:NCI109， 7:IMDBBINARY 8：IMDBMULTI,9:PROTEINS, REDDITMULTI5K
